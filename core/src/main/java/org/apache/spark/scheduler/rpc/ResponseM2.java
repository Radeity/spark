...
public class ResponseM2 implements org.apache.thrift.TBase<ResponseM2, ResponseM2._Fields>, java.io.Serializable, Cloneable, Comparable<ResponseM2> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputSize = new java.util.ArrayList<java.util.List<java.util.List<java.lang.Long>>>(_list96.size);
                @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.Long>> _elem97;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ResponseM2 struct) throws org.apache.thrift.TException {
      ...
      if (struct.outputSize != null) {
        oprot.writeFieldBegin(OUTPUT_SIZE_FIELD_DESC);
        {
          ...
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.LIST, _iter105.size()));
              for (java.util.List<java.lang.Long> _iter106 : _iter105)
              {
                {
                  oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter106.size()));
  ...
  private static class ResponseM2TupleScheme extends org.apache.thrift.scheme.TupleScheme<ResponseM2> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ResponseM2 struct) throws org.apache.thrift.TException {
      ...
      struct.setResCodeIsSet(true);
      {
        org.apache.thrift.protocol.TList _list111 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.outputSize = new java.util.ArrayList<java.util.List<java.util.List<java.lang.Long>>>(_list111.size);
        @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.Long>> _elem112;
        for (int _i113 = 0; _i113 < _list111.size; ++_i113)
        {
          {
            org.apache.thrift.protocol.TList _list114 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
            ...
            {
              {
                org.apache.thrift.protocol.TList _list117 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
