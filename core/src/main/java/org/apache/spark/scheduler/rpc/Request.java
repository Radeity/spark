...
public class Request implements org.apache.thrift.TBase<Request, Request._Fields>, java.io.Serializable, Cloneable, Comparable<Request> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.util.List<java.lang.Integer>>> outputSize; // optional
  ...
  public Request setSiteLoad(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> siteLoad) {
  ...
  public Request setAlpha(double alpha) {
    this.alpha = alpha;
    setAlphaIsSet(true);
    return this;
  }
      ...
      if (struct.outputSize != null) {
        if (struct.isSetOutputSize()) {
          oprot.writeFieldBegin(OUTPUT_SIZE_FIELD_DESC);
          {
            ...
            for (java.util.List<java.util.List<java.lang.Integer>> _iter28 : struct.outputSize)
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.LIST, _iter28.size()));
                for (java.util.List<java.lang.Integer> _iter29 : _iter28)
                {
                  {
      ...
      if (struct.isSetOutputSize()) {
        {
          ...
          for (java.util.List<java.util.List<java.lang.Integer>> _iter36 : struct.outputSize)
          {
            {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.outputSize = new java.util.ArrayList<java.util.List<java.util.List<java.lang.Integer>>>(_list52.size);
          @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.Integer>> _elem53;
          for (int _i54 = 0; _i54 < _list52.size; ++_i54)
          {
            {
              org.apache.thrift.protocol.TList _list55 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
              _elem53 = new java.util.ArrayList<java.util.List<java.lang.Integer>>(_list55.size);
              @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> _elem56;
              for (int _i57 = 0; _i57 < _list55.size; ++_i57)
              {
                {
                  org.apache.thrift.protocol.TList _list58 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
                  _elem56 = new java.util.ArrayList<java.lang.Integer>(_list58.size);
                  int _elem59;
